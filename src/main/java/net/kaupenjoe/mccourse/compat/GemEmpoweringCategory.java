...
public class GemEmpoweringCategory implements DisplayCategory<BasicDisplay> {
    ...
    public Renderer getIcon() {
        return EntryStacks.of(ModBlocks.GEM_EMPOWERING_STATION.asItem().getDefaultInstance());
    }
    ...
    public List<Widget> setupDisplay(BasicDisplay display, Rectangle bounds) {
        ...
        widgets.add(Widgets.createTooltip(new Rectangle(startPoint.x + 156, startPoint.y + 11, 8, 64), Component.literal("Needs " + ((GemEmpoweringDisplay) display).getTotalEnergyAmount() + " E")));
        ...
        widgets.add(Widgets.createDrawableWidget((graphics, mouseX, mouseY, delta) -> {
            ...
            graphics.blit(startPoint.x + 26, startPoint.y + 49, 1, 16, 1, FluidVariantRendering.getSprite(FluidVariant.of(Fluids.WATER)));
            RenderSystem.setShaderColor(1F, 1F, 1F, 1F);
        }));
        widgets.add(Widgets.createTooltip(new Rectangle(startPoint.x + 26, startPoint.y + 11, 16, 39), Component.literal("Needs 500mB Water")));
